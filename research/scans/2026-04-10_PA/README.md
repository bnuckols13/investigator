...
- **14,888** organizations scanned
- **12,068** organizations with anomaly flags
- **100** organizations scoring above 50
- **Average anomaly score:** 20.0
...
```bash
cd ~/investigator
git checkout 52c6fb3acc2f
python investigate.py scan run --scope PA
```
